...
public class OhTheCommandity {
    private static void genAdminCom(CommandSender sender, String permPath, String mesPath) {
        ...
        HiddenSwitch.log.info(HiddenSwitch.logName + me.lang.getLang().getString(mesPath));
    }
    ...
    public static void lchs(CommandSender sender, String[] args) {
        ...
        for (String hold : args) {
            ...
            if (strings[0].equals("user")) {
                ...
                /*
                 * Does the player have permission to set a user lock?
                 */
                ...
                /*
                 * Does the player have permission to set an item lock?
                 */
                if (player.hasPermission("hiddenswitch.user.lockitem")) {
