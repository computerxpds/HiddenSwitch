...
public class Lang {
    ...
    public Lang() {
        ...
        File file = new File(HiddenSwitch.instance.getDataFolder(),
                             "lang/" + HiddenSwitch.instance.getConfig().getString("lchs.config.language-file")
                    );
    ...
    public void reloadLang() {
        ...
        if (!langFile.exists()) {
            ...
            HiddenSwitch.log.warning(
                HiddenSwitch.logName + "Could not find language file specified in config.yml defaulting to english."
            );
            ...
            text.setDefaults(loadDefaults());
            text.options().copyDefaults(true);
